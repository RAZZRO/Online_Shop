package ir.znu.sad.business.authentication;
...
public class UserAuthenticator {
    ...
    public static UserAuthenticationBusinessType authenticateUser(Authentication authentication) throws IOException {
        if(authentication.getUser()==authentication.getPass()){
            return UserAuthenticationBusinessType.LIMITED_USER;
        }
        return dataClient.authenticate(authentication).getBusinessType();
    }
